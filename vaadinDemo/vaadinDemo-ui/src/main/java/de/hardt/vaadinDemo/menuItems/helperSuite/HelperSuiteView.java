...
public class HelperSuiteView extends VerticalLayout implements View {
	private static final long serialVersionUID = -9179711654311087264L;
    ...
    public HelperSuiteView() {
        ...
        deusContent.addComponent(new Label("<h1>Helper Suite View</h1>", ContentMode.HTML), "header");
        deusContent.addComponent(new Label("Hier kommen alle Elemente der HelperSuite hin ...", ContentMode.TEXT), "info");
        setSizeFull();
        setMargin(false);
