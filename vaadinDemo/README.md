...
- vaadinDemo-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- vaadinDemo-ui: main application module, development time
- vaadinDemo-production: module that produces a production mode WAR for deployment
